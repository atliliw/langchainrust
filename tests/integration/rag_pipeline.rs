...
use langchainrust::{
    Document, InMemoryVectorStore, RecursiveCharacterSplitter, RetrieverTrait, SimilarityRetriever,
...
async fn test_rag_full_pipeline() {
    ...
    let chunks: Vec<Document> = knowledge_base
        .iter()
        .flat_map(|doc| {
            splitter

...
fn test_calculator_addition() {
    ...
    let result = rt
        .block_on(calc.run("{\"expression\": \"2 + 3\"}".to_string()))
        .unwrap();
...
fn test_calculator_multiplication() {
    ...
    let rt = tokio::runtime::Runtime::new().unwrap();
    let result = rt
        .block_on(calc.run("{\"expression\": \"10 * 5\"}".to_string()))
        .unwrap();
...
fn test_calculator_division() {
    ...
    let rt = tokio::runtime::Runtime::new().unwrap();
    let result = rt
        .block_on(calc.run("{\"expression\": \"100 / 4\"}".to_string()))
        .unwrap();
...
fn test_datetime_now() {
    ...
    let rt = tokio::runtime::Runtime::new().unwrap();
    let result = rt
        .block_on(dt_tool.run("{\"operation\": \"now\"}".to_string()))
        .unwrap();
...
fn test_math_sqrt() {
    ...
    let rt = tokio::runtime::Runtime::new().unwrap();
    let result = rt
        .block_on(math_tool.run("{\"operation\": \"sqrt\", \"value\": 16}".to_string()))
        .unwrap();
...
fn test_math_factorial() {
    ...
    let rt = tokio::runtime::Runtime::new().unwrap();
    let result = rt
        .block_on(math_tool.run("{\"operation\": \"factorial\", \"value\": 5}".to_string()))
        .unwrap();
...
fn test_math_power() {
    ...
    let result = rt
        .block_on(
            math_tool.run("{\"operation\": \"power\", \"value\": 2, \"value2\": 8}".to_string()),
        )
        .unwrap();
...
async fn test_calculator_async() {
    let calc = Calculator::new();
    let result = calc
        .run("{\"expression\": \"15 + 27\"}".to_string())
        .await
        .unwrap();
